...
<The single next action, precise enough to begin without deciding anything.
"Open src/vault/index.ts and implement the watcher branch marked TODO(watch)."
Not "continue with the vault".>
...
## Changed since the briefing

<Anything that makes BRIEFING.md wrong. If nothing, write "nothing" — the
...
<Work that was in scope and skipped, with the reason. Prevents the next session
from treating it as an oversight and redoing the reasoning.>
